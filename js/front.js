...
function map() {
    ...
    if ($('#' + mapId).length > 0) {
        ...
        var Stamen_TonerLite = L.tileLayer('http://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png', {
            attribution: 'Map tiles by <a href="http://www.openstreetmap.org">OpenStreetMap</a>, <a href="http://creativecommons.org/licenses/by/3.0">CC BY 3.0</a> &mdash; Map data &copy; <a href="https://www.openstreetmap.org/copyright">OpenStreetMap</a> contributors',
            subdomains: 'abcd',
            minZoom: 0,
            maxZoom: 20,
            ext: 'png'
        ...
        if (mapMarker) {
            ...
            marker.bindPopup("<div class='p-4'><h5>University of Salzburg</h5><p>Interfaculty Department of Geoinformatics - Z_GIS<br>Copernicus Masters in Digital Earth</p></div>", {
                minwidth: 200,
                maxWidth: 600,
